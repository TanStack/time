...
- [MoveController](classes/MoveController.md)
...
- [CalculateMovedEventOptions](interfaces/CalculateMovedEventOptions.md)
...
- [EventMutationError](interfaces/EventMutationError.md)
...
- [MoveConstraints](interfaces/MoveConstraints.md)
- [MoveControllerOptions](interfaces/MoveControllerOptions.md)
- [MovedEventResult](interfaces/MovedEventResult.md)
- [MoveFeatureApi](interfaces/MoveFeatureApi.md)
- [MoveHost](interfaces/MoveHost.md)
- [MovePeers](interfaces/MovePeers.md)
...
- [TimeEventRecord](interfaces/TimeEventRecord.md)
...
- [ValidateMoveOptions](interfaces/ValidateMoveOptions.md)
- [ValidateMoveResult](interfaces/ValidateMoveResult.md)
...
- [EventMutationKind](type-aliases/EventMutationKind.md)
...
- [ResizeError](type-aliases/ResizeError.md)
...
- [calculateDayShift](functions/calculateDayShift.md)
...
- [calculateMovedEvent](functions/calculateMovedEvent.md)
...
- [eventMoveFeature](functions/eventMoveFeature.md)
...
- [getDateParts](functions/getDateParts.md)
...
- [snapToInterval](functions/snapToInterval.md)
