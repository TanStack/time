---
id: GetDayOfYearOptions
title: GetDayOfYearOptions
---

# Interface: GetDayOfYearOptions

Defined in: [date/getDayOfYear/getDayOfYear.ts:5](https://github.com/TanStack/time/blob/main/packages/time/src/date/getDayOfYear/getDayOfYear.ts#L5)
