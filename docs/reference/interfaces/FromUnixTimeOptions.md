---
id: FromUnixTimeOptions
title: FromUnixTimeOptions
---

# Interface: FromUnixTimeOptions

Defined in: [date/fromUnixTime/fromUnixTime.ts:6](https://github.com/TanStack/time/blob/main/packages/time/src/date/fromUnixTime/fromUnixTime.ts#L6)
