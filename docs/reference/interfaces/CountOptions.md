...
Defined in: [date/count/count.ts:16](https://github.com/TanStack/time/blob/main/packages/time/src/date/count/count.ts#L16)
...
Defined in: [date/count/count.ts:17](https://github.com/TanStack/time/blob/main/packages/time/src/date/count/count.ts#L17)
