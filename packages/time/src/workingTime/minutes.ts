...
export function mergeMinuteRanges(ranges: Array<MinuteRange>): Array<MinuteRange> {
...
export function invertMinuteRanges(merged: Array<MinuteRange>): Array<MinuteRange> {
