...
export type Locale = string | Intl.Locale | Array<string> | Array<Intl.Locale>
...
export interface DateTimeFormatterOptions extends DateFormatterOptions, TimeFormatterOptions {}
