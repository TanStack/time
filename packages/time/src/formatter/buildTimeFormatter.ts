...
import type { ITimeFormatterBuildParams, ITimeFormatterOptions } from './shared'
 ...
 * @param {ITimeFormatterBuildParams} [param0]
...
export function buildTimeFormatter({
  ...
  const { timeStyle, ...rest } = formatOptions as ITimeFormatterOptions
  const newOptions = {
    ...localeOptions,
