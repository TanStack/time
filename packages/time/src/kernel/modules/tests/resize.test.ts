...
describe('resizeModule', () => {
  it('expands a resize intent into an update', () => {
    ...
    const result = kernel.write(resizeIntent({ eventId: 'e1', edge: 'bottom', deltaMinutes: 60 }))
  ...
  it('moves the start when the top edge is dragged', () => {
    ...
    kernel.write(resizeIntent({ eventId: 'e1', edge: 'top', deltaMinutes: -30 }))
  ...
  it('snaps the delta to the configured interval', () => {
    ...
    kernel.write(resizeIntent({ eventId: 'e1', edge: 'bottom', deltaMinutes: 20 }))
  ...
  it('keeps the minimum duration', () => {
    ...
    kernel.write(resizeIntent({ eventId: 'e1', edge: 'top', deltaMinutes: 120 }))
  ...
  it("stops at the resource's availability edge", () => {
    ...
    kernel.write(resizeIntent({ eventId: 'e1', edge: 'bottom', deltaMinutes: 120 }))
  ...
  it('drops a resize aimed at an unknown event', () => {
    ...
    const result = kernel.write(resizeIntent({ eventId: 'gone', edge: 'bottom', deltaMinutes: 60 }))
