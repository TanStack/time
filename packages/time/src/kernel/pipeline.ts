...
export class StageRegistry<E extends KernelEvent> {
  private projection = new Map<ProjectionModuleStageName, Array<Entry<ProjectionStage<E>>>>()
  private transform = new Map<WriteTransformStageName, Array<Entry<TransformStage<E>>>>()
  private validate = new Map<WriteValidateStageName, Array<Entry<ValidateStage<E>>>>()
  ...
  projectionStages(stage: ProjectionModuleStageName): Array<ProjectionStage<E>> {
