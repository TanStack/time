...
describe('checkDaySpan', () => {
  ...
  it('blocks a day the resource never works', () => {
    ...
    expect(conflict!.resourceDetails[0]!.description).toBe('Office: Not available on this day')
  })
  ...
  it('treats a missing consumption as one unit', () => {
    ...
    expect(conflicts[0]!.description).toBe('Desk: Capacity exceeded (3/2 units used)')
  })
