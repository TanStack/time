...
import type { RecurrenceEditApi, RecurrenceNavigationApi, RecurrenceReadApi } from './recurrence'
...
export type FullFeatureApi<
  ...
  TEvent extends Event<TResource>,
> = UnionToIntersection<
  FeatureApiRegistry<TResource, TEvent>[keyof FeatureApiRegistry<TResource, TEvent>]
>
...
export type BuiltInFeatureApi<
  ...
  TEvent extends Event<TResource>,
> = UnionToIntersection<
  BuiltInFeatureApiRegistry<TResource, TEvent>[keyof BuiltInFeatureApiRegistry<TResource, TEvent>]
>
...
} as const satisfies Record<keyof BuiltInFeatureApi<Resource, Event<Resource>>, string>
