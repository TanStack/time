...
function createHost(overrides: Partial<ResizeHost<TestResource, TestEvent>> = {}, daysInView = 1) {
...
async function drag(controller: ResizeController<TestResource, TestEvent>, clientY: number) {
