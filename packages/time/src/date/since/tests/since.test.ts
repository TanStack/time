...
describe('since', () => {
  describe('with string inputs', () => {
    test('should calculate duration in days', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-16T14:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'day',
      })
    ...
    test('should calculate duration in hours', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-15T16:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'hour',
      })
    ...
    test('should calculate duration in minutes', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-15T14:44:12.789Z', {
        timeZone: 'UTC',
        unit: 'minute',
      })
      expect(duration).toBe(2)
    ...
    test('should calculate duration in seconds', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-15T14:42:57.789Z', {
        timeZone: 'UTC',
        unit: 'second',
      })
    ...
    test('should calculate duration in milliseconds', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-15T14:42:12.889Z', {
        timeZone: 'UTC',
        unit: 'millisecond',
      })
    ...
    test('should calculate complex duration', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-16T17:12:12.789Z', {
        timeZone: 'UTC',
        unit: 'day',
      })
    ...
    test('should calculate duration in months', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-04-15T14:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'month',
      })
      expect(duration).toBe(1)
    ...
    test('should calculate duration in years', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2025-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'year',
      })
      expect(duration).toBe(1)
    ...
    test('should calculate duration in weeks', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-29T14:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'week',
      })
      expect(duration).toBe(2)
  ...
  describe('with negative duration', () => {
    test('should return negative duration when end is before start', () => {
      const duration = since('2024-03-16T14:42:12.789Z', '2024-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'day',
      })
      expect(duration).toBe(-1)
    ...
    test('should return zero duration when dates are equal', () => {
      const duration = since('2024-03-15T14:42:12.789Z', '2024-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
        unit: 'day',
      })
