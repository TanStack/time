...
describe('set', () => {
  ...
  describe('with different input types', () => {
    ...
    test('should work with ZonedDateTime', () => {
      const zdt = Temporal.ZonedDateTime.from('2024-03-15T14:42:12Z[UTC][u-ca=gregory]')
  ...
  describe('timezone handling', () => {
    test('should set the field on the local clock, not on UTC', () => {
      ...
      expect(set('2024-03-15T14:42:12Z', { fields, timeZone: 'UTC' }).toISOString()).toBe(
        '2024-03-15T09:42:12.000Z',
      )
    })
  })
