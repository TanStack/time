...
describe('isSameOrAfter', () => {
  describe('with string inputs', () => {
    test('should return true when first date is after second date at day level', () => {
      const result = isSameOrAfter('2024-03-16T14:42:12.789Z', '2024-03-15T14:42:12.789Z', {
        unit: 'day',
        timeZone: 'UTC',
      })
    ...
    test('should return true when dates are equal at day level', () => {
      const result = isSameOrAfter('2024-03-15T23:59:59Z', '2024-03-15T10:00:00Z', {
        unit: 'day',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    ...
    test('should return false when first date is before second date at day level', () => {
      const result = isSameOrAfter('2024-03-15T14:42:12.789Z', '2024-03-16T14:42:12.789Z', {
        unit: 'day',
        timeZone: 'UTC',
      })
    ...
    test('should handle year level comparison', () => {
      const result = isSameOrAfter('2024-12-31T23:59:59Z', '2024-01-01T00:00:00Z', {
        unit: 'year',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    ...
    test('should handle month level comparison', () => {
      const result = isSameOrAfter('2024-03-31T23:59:59Z', '2024-03-01T00:00:00Z', {
        unit: 'month',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    ...
    test('should handle week level comparison', () => {
      const result = isSameOrAfter('2024-03-17T23:59:59Z', '2024-03-11T00:00:00Z', {
        unit: 'week',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    ...
    test('should handle hour level comparison', () => {
      const result = isSameOrAfter('2024-03-15T14:59:59Z', '2024-03-15T14:00:00Z', {
        unit: 'hour',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
  ...
  describe('with different input types', () => {
    ...
    test('should work with ZonedDateTime', () => {
      const zdt1 = Temporal.ZonedDateTime.from('2024-03-15T23:59:59Z[UTC][u-ca=gregory]')
      const zdt2 = Temporal.ZonedDateTime.from('2024-03-15T10:00:00Z[UTC][u-ca=gregory]')
  ...
  describe('timezone handling', () => {
    test('should respect timezone', () => {
      const result = isSameOrAfter('2024-03-15T19:00:00Z', '2024-03-15T14:00:00Z', {
        unit: 'day',
  ...
  describe('edge cases', () => {
    test('should handle different years correctly', () => {
      const result = isSameOrAfter('2024-01-01T00:00:00Z', '2023-12-31T23:59:59Z', {
        unit: 'year',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    ...
    test('should handle leap year dates', () => {
      const result = isSameOrAfter('2024-02-29T00:00:00Z', '2024-02-28T00:00:00Z', {
        unit: 'day',
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
