...
describe('endOf', () => {
  describe('with string input', () => {
    test('should return end of year', () => {
      const result = endOf('2024-03-15T14:42:12.789Z', { unit: 'year' }, {
        timeZone: 'UTC',
      })
    ...
    test('should return end of month', () => {
      const result = endOf('2024-03-15T14:42:12.789Z', { unit: 'month' }, {
        timeZone: 'UTC',
      })
    ...
    test('should return end of day', () => {
      const result = endOf('2024-03-15T14:42:12.789Z', { unit: 'day' }, {
        timeZone: 'UTC',
      })
  ...
  describe('edge cases', () => {
    test('should handle end of year for December 31st', () => {
      const result = endOf('2024-12-31T00:00:00Z', { unit: 'year' }, {
        timeZone: 'UTC',
      })
      expect(result.value).toBe('2024-12-31T23:59:59.999Z')
    })
    ...
    test('should handle end of month for last day', () => {
      const result = endOf('2024-03-31T00:00:00Z', { unit: 'month' }, {
        timeZone: 'UTC',
      })
      expect(result.value).toBe('2024-03-31T23:59:59.999Z')
    })
    ...
    test('should handle end of month for February in leap year', () => {
      const result = endOf('2024-02-15T00:00:00Z', { unit: 'month' }, {
        timeZone: 'UTC',
      })
    ...
    test('should handle end of month for February in non-leap year', () => {
      const result = endOf('2023-02-15T00:00:00Z', { unit: 'month' }, {
        timeZone: 'UTC',
      })
    ...
    test('should handle end of day at 23:59:59', () => {
      const result = endOf('2024-03-15T23:59:59Z', { unit: 'day' }, {
        timeZone: 'UTC',
      })
      expect(result.value).toBe('2024-03-15T23:59:59.999Z')
    })
