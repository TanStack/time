...
describe('isAfter', () => {
  describe('with string inputs', () => {
    test('should return true when first date is after second date', () => {
      const result = isAfter('2024-03-16T14:42:12.789Z', '2024-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
      })
    ...
    test('should return false when first date is before second date', () => {
      const result = isAfter('2024-03-15T14:42:12.789Z', '2024-03-16T14:42:12.789Z', {
        timeZone: 'UTC',
      })
    ...
    test('should return false when dates are equal', () => {
      const result = isAfter('2024-03-15T14:42:12.789Z', '2024-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
      })
      expect(result).toBe(false)
    })
    ...
    test('should handle different months', () => {
      const result = isAfter('2024-03-15T14:42:12.789Z', '2024-02-15T14:42:12.789Z', {
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    })
    ...
    test('should handle different years', () => {
      const result = isAfter('2024-03-15T14:42:12.789Z', '2023-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    })
  ...
  describe('with different input types', () => {
    ...
    test('should work with ZonedDateTime', () => {
      const zdt1 = Temporal.ZonedDateTime.from('2024-03-16T14:42:12.789Z[UTC][u-ca=gregory]')
      const zdt2 = Temporal.ZonedDateTime.from('2024-03-15T14:42:12.789Z[UTC][u-ca=gregory]')
  ...
  describe('edge cases', () => {
    test('should handle milliseconds precision', () => {
      const result = isAfter('2024-03-15T14:42:12.790Z', '2024-03-15T14:42:12.789Z', {
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
    })
