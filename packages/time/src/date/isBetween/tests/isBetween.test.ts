...
describe('isBetween', () => {
  describe('with inclusive range (default)', () => {
    test('should return true when date is between start and end', () => {
      const result = isBetween('2024-03-16T14:42:12.789Z', {
        range: {
    ...
    test('should return true when date equals start', () => {
      const result = isBetween('2024-03-15T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
        },
    ...
    test('should return true when date equals end', () => {
      const result = isBetween('2024-03-17T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
        },
    ...
    test('should return false when date is before start', () => {
      const result = isBetween('2024-03-14T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
        },
    ...
    test('should return false when date is after end', () => {
      const result = isBetween('2024-03-18T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
        },
  ...
  describe('with exclusive range', () => {
    test('should return true when date is strictly between start and end', () => {
      const result = isBetween('2024-03-16T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
    ...
    test('should return false when date equals start', () => {
      const result = isBetween('2024-03-15T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
    ...
    test('should return false when date equals end', () => {
      const result = isBetween('2024-03-17T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
          end: '2024-03-17T14:42:12.789Z',
  ...
  describe('with inclusive start only', () => {
    test('should return true when date equals start', () => {
      const result = isBetween('2024-03-15T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
  ...
  describe('with inclusive end only', () => {
    test('should return true when date equals end', () => {
      const result = isBetween('2024-03-17T14:42:12.789Z', {
        range: {
          start: '2024-03-15T14:42:12.789Z',
  ...
  describe('with different input types', () => {
    ...
    test('should work with ZonedDateTime', () => {
      ...
      const result = isBetween(zdt, {
        range: {
          start: Temporal.ZonedDateTime.from('2024-03-15T14:42:12.789Z[UTC][u-ca=gregory]'),
          end: Temporal.ZonedDateTime.from('2024-03-17T14:42:12.789Z[UTC][u-ca=gregory]'),
        },
        timeZone: 'UTC',
      })
      expect(result).toBe(true)
  ...
  describe('timezone handling', () => {
    test('should respect timezone', () => {
      const result = isBetween('2024-03-16T14:00:00Z', {
        range: {
