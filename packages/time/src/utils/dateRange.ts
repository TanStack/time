...
function toPlainDate(input: DateInput, calendar: Temporal.CalendarLike): Temporal.PlainDate {
...
export function parseDateRange({ range, calendar }: ParseDateRangeOptions): ParsedDateRange {
  if (!range) {
