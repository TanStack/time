export const tokens = {
  ...
  shadow: {
    xs: (_: string = 'rgb(0 0 0 / 0.1)') => `0 1px 2px 0 rgb(0 0 0 / 0.05)` as const,
    ...
    '2xl': (color: string = 'rgb(0 0 0 / 0.25)') => `0 25px 50px -12px ${color}` as const,
    inner: (color: string = 'rgb(0 0 0 / 0.05)') => `inset 0 2px 4px 0 ${color}` as const,
    none: () => `none` as const,
  },
  zIndices: {
    hide: -1,
